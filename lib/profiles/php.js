        ...
        if (fs.existsSync(composerFile)) {
            ...
            for(i in composerManifest.autoload) {
                ...
                if (i === 'psr-0') {
                    ...
                    for(j in classmap) {
                        var classes = classmapCollectClasses(this.package.baseDir, classmap[j]);
...
PHP.prototype.preInstall = function(p) {
    'use strict';

    p.dependencies['reekoheek/reek-php'] = '';
};

PHP.prototype.postInstall = function(p) {
    'use strict';
    ...
    fs.writeFileSync(autoloadF, "<?php\n\nrequire '../vendor/reekoheek/reek-php/src/autoload.php';");
};
