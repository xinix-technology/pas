...
Package.prototype.pull = function() {
    ...
    return Promise.resolve(this.query.provider.pull(from, to))
        .then(function() {
            return this.populateData();
        }.bind(this));
};
...
Package.prototype.up = function(opts) {
    'use strict';

    if (this.getProfile().up) {
        return Promise.resolve(this.getProfile().up(this, opts));
    }
};
...
Package.prototype.install = function() {
    ...
    var origin = this.getCacheDirectory(),
        destination = this.getInstalledDirectory();
    ...
    if (fs.existsSync(origin)) {
        ...
        return Promise.reject(new Error('No origin file'));
    }
};
